...
class IntlPhoneFieldd extends StatefulWidget {
  ...
  @override
  _IntlPhoneFielddState createState() => _IntlPhoneFielddState();
}

class _IntlPhoneFielddState extends State<IntlPhoneFieldd> {
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      decoration: widget.decoration.copyWith(
        contentPadding: EdgeInsets.symmetric(vertical: margin_12),
      ...
      validator: (value) {
        if (value == null || value.length == 0) {
          return "     " + (keyMobileNumber.tr) + ' ' + (keyCannotBeEmpty.tr);
        } else {
