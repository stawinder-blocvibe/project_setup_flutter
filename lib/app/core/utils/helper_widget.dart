...
Center resultNotFound({message}) => Center(
  child: Text(message ?? "No result found", style: textStyleBodyMedium()),
);
...
ReadMoreTextWidget readMoreWidget({
  required normalOrHtmlText,
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            geniusButton(onTap: onTapGenius,isHomeScreen: isHomeScreen).marginOnly(right: margin_10),
            onlyWallet
                ? GestureDetector(
                    onTap: () {
...
Widget geniusButton({onTap,isHomeScreen}) {
  return Obx(() => GestureDetector(onTap: onTap, child: handleGeniusButton(isHomeScreen: isHomeScreen)));
}

handleGeniusButton({isHomeScreen = false}) {
  if (isGenius.value) {
    return Chip(
      shape: const StadiumBorder(
        side: BorderSide(color: Colors.white24), // Optional outline
      ),
      backgroundColor: const Color(0xFF237E53), // Custom green
  ...
  } else if(!isGenius.value && isHomeScreen==true){
    return Container(
      ...
      decoration: BoxDecoration(
        gradient:
            ...
            const LinearGradient(
              colors: [Color(0xFFFA6162), Color(0xFFFE2224)],
            ),
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  ).marginOnly(bottom: margin_25, right: margin_25),
                ],
...
Widget contestCellWidget({onTap, required PoolModel pool,margin,wantPaidText = false}) {
  return GestureDetector(
    onTap: onTap,
    child: Container(
      margin: margin,
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      (wantPaidText==true)?
                          'Paid Amount: $rupee${pool.joiningPrice.toString()}':
  ...
  return Row(
    ...
    children: [
      ...
      isT20
          ...
          : dayTimingWidget(
              dateTime:
                  upcomingMatch?.startDatetime ?? DateTime.now().toString(),
            ),
          ...
          .map(
            (name) => Container(
              ...
              decoration: ShapeDecoration(
                ...
                shape: RoundedRectangleBorder(
                  side: BorderSide(width: 0.30, color: const Color(0xFFD27D08)),
                  borderRadius: BorderRadius.circular(5),
                ),
              ),
              child: Text(
